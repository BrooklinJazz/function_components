defmodule FunctionComponentsNative do
  import FunctionComponentsWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([FunctionComponentsWeb, CoreComponents, plugin.module_suffix])
